...
async function createProvincesTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Provinces_Region ON Provinces(AdministrativeRegionID)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Provinces_Unit ON Provinces(AdministrativeUnitID)`);
}
...
async function createDistrictsTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Districts_Province ON Districts(ProvinceCode)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Districts_Unit ON Districts(AdministrativeUnitID)`);
}
...
async function createPaymentMethodsTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_PaymentMethods_UserID ON PaymentMethods(UserID)`);
}
...
async function createProductsTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Products_ProvinceCode ON Products(ProvinceCode)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Products_DistrictCode ON Products(DistrictCode)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Products_Price ON Products(Price)`);
}
...
async function createProductAmenitiesTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_product_amenities_product ON ProductAmenities(ProductID)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_product_amenities_amenity ON ProductAmenities(AmenityID)`);
}
...
async function createAuctionTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Auction_ProductID ON Auction(ProductID)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Auction_StartTime ON Auction(StartTime)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Auction_Status_EndTime ON Auction(Status, EndTime)`);
}
...
async function createBidsTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Bids_AuctionID ON Bids(AuctionID)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Bids_UserID ON Bids(UserID)`);
}
...
async function createBookingTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Booking_UserID ON Booking(UserID)`);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Booking_ProductID ON Booking(ProductID)`);
}
...
async function createRatingTable() {
    ...
    `);
    await pool.execute(`CREATE INDEX IF NOT EXISTS idx_Rating_ProductID ON Rating(ProductID)`);
}
