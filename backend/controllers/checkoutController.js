...
const BASE_URL = process.env.BASE_URL || 'https://6ff11c645fba.ngrok-free.app'; //frontend
const BACKEND_URL = process.env.BACKEND_URL || 'https://c746cd803729.ngrok-free.app'; //backend
